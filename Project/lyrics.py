...
def extract_lyrics():
    ...
    link = 'https://youtu.be/KVh4KtUSW3A?si=vdjFmE9d8lZIfWcK' + artist_name.replace(' ', '%20') + '/' + song_name.replace(' ', '%20')
...
root = Tk()
root.title("Swati's Song Lyrics Extractor")
root.geometry("600x200")
root.resizable(0, 0)
root.config(bg='CadetBlue')

# Placing the components
Label(root, text="Swati's Song Lyrics Extractor", font=("Comic Sans MS", 16, 'bold'), bg='CadetBlue').pack(side=TOP, fill=X)
